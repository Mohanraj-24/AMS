        ...
        <li class="dropdown user user-menu"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-user fa-lg"></i> <span class="hidden-xs"><?php echo $_SESSION['objLogin']['e_name']; ?></span> </a>
          <ul class="dropdown-menu">
            ...
            <li class="user-header"> <img src="<?php echo $image; ?>" class="img-circle" alt="User Image" />
              <p><?php echo $_SESSION['objLogin']['e_name']; ?><small><?php echo "Amenity Manager";?><br/><?php echo $_SESSION['objLogin']['branch_name']; ?></small> </p>
            </li>
            <!-- Menu Body -->
            <!-- Menu Footer-->
...
<aside class="main-sidebar">
  ...
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      <li class="<?php if($page_name != '' && $page_name == 'am_dashboard'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>am_dashboard.php"><i class="fa fa-dashboard"></i> <span><?php echo $_data['menu_dashboard'];?></span></a> </li>
       <li class="<?php if($page_name != '' && $page_name == 'salary_details'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>am_dashboard/salary_details.php"><i class="fa fa fa-money"></i><span><?php echo $_data['salary_statement'];?></span></a></li>
       <li class="<?php if($page_name != '' && $page_name == 'e_report'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>am_dashboard/e_report.php"><i class="fa fa fa fa-bar-chart-o"></i><span><?php echo $_data['salary_report'];?></span></a></li>
       <li class="<?php if($page_name != '' && $page_name == 'amenitylist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>am_dashboard/amenitylist.php"><i class="fa fa fa fa-bar-chart-o"></i><span><?php echo "Amenity List";?></span></a></li>
       <li class="treeview <?php if($page_name != '' && $page_name == 'addfair' || $page_name == 'fairlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-money"></i> <span><?php echo "Amenity Details"; ?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        <ul class="treeview-menu">
          <li class="<?php if($page_name != '' && $page_name == 'addfair'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>am_dashboard/addfair.php"><i class="fa fa-arrow-circle-right"></i><?php echo "Add Amenity"; ?></a></li>
		  <li class="<?php if($page_name != '' && $page_name == 'fairlist'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>am_dashboard/fairlist.php"><i class="fa fa-arrow-circle-right"></i><?php echo "Amenity List"; ?></a></li>
        </ul>
      </li>
    </ul>
  </section>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h4 align="center"><?php echo "Amenity Manager";?>
          </h4>
