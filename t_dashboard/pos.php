	...
	<body>
		<div class="w3-container w3-main" style="margin-top:13vh;" id="main">
			<div class="w3-container w3-content" style="max-width:400px;">
				...
				<div class="w3-card-4 w3-display-container" id="<?=$id?>" style="color: black;">
					...
					<div class="w3-container w3-center" id="detailsWrap">
						<div class="w3-col w3-container">
							...
							<p class="w3-text-black" id="postAuth" style="margin-right:-180px;margin-top:-40px;">Posted by: <a href="profile.php?user=<?=$username?>"><?=$username?></a></p>
						</div>
					</div>
				</div>
				...
				?>
				<div class="w3-container w3-padding-16 w3-border-bottom w3-border-black w3-display-container cam-red" id="<?=$comment_id?>">
					<div class="w3-row">
