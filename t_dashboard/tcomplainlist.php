    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <table class="table sakotable table-bordered table-striped dt-responsive">
          ...
          <tbody>
            <?php
				$result = mysqli_query($conn, "SELECT * FROM tbl_add_complain where branch_id = " . (int)$_SESSION['objLogin']['branch_id'] . " and c_userid=" . (int)$_SESSION['objLogin']['rid'] . " order by complain_id");
