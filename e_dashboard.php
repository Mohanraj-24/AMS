...
?>
    ...
    <section class="content">
	  ...
	  <!-- col start -->
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-aqua">
            <div class="inner"><h3>Complain</h3>
              <p><?php echo "List";?></p>
            </div>
            <div class="icon"> <img height="80" width="80" src="img/maintenance.png"></a> </div>
            <a href="<?php echo WEB_URL; ?>e_dashboard/ecomplainlist.php" class="small-box-footer"><?php echo $_data['dashboard_more_info'];?> <i class="fa fa-arrow-circle-right"></i></a> </div>
        </div>
      </div>
      <!-- /.row end -->
    </section>
