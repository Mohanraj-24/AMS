...
<aside class="main-sidebar">
  ...
  <section class="sidebar" style="margin-top:10px;">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php if($page_name != '' && $page_name == 'addtcomplain' || $page_name == 'tcomplainlist'){echo 'active';}?>"> <a href="#"> <i class="fa fa-warning"></i> <span><?php echo $_data['menu_complain'];?></span> <i class="fa fa-angle-left pull-right"></i> </a>
        ...
        <li class="<?php if($page_name != '' && $page_name == 'index'){echo 'active';}?>"><a href="<?php echo WEB_URL; ?>t_dashboard/amenitylist.php"><i class="fa fa-bar-chart-o"></i><span><?php echo "Amenity List"?></span></a></li>
